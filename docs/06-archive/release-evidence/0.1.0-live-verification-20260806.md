...
> 实施状态：completed
> SSOT 同步：synced
> 对应事实源：docs/03-workflows/release-verification.md
> 替代关系：由 docs/03-workflows/release-verification.md 替代
> 最后复核时间：2026-08-06
> 归档原因：0.1.0 验证过程混合了流程、状态和调查日志；当前流程与状态已提取到工作流 SSOT
> 原始路径：docs/live-test-runbook.md
> 归档时间：2026-08-06
