...
Supported releases and their QM compatibility envelope are listed in `docs/01-architecture/compatibility.md`. Security fixes target the latest supported release.
